...
def learn():
    ...
    return "I leanred the basics of python. As well more complicated areas like numpy and pandas. Found numpy dataframes very interesting"
